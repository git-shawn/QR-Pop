...
class CodeScannerController: NSViewController {
...
extension CodeScannerController: AVCaptureVideoDataOutputSampleBufferDelegate {
...
struct CodeScannerControllerRepresentable: NSViewControllerRepresentable {
    var completionHandler: ((_ payload: String?) -> Void)
    
    func makeNSViewController(context: Context) -> some NSViewController {
        let controller = CodeScannerController(completionHandler: {payload in
            completionHandler(payload)
        })
        return controller
    }
