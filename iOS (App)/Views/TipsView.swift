    ...
    var body: some View {
        HStack(spacing: 20){
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text("How to make a QR code from the Share Sheet")
                    .font(.headline)
                Text("It's possible, using QR Pop, to turn almost any URL into a QR code. Whenever you have the opportunity to share a URL throughout iOS, the \"Generate QR Code\" option will appear at the bottom of the share sheet. Just long-press a link and select \"Share\" to find it!")
