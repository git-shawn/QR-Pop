            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    Group {
                        Text("What's new?")
                            .font(.headline)
                        Text("You can now create QR codes everywhere in macOS using the Share button. Just open an app that shares links, press share, and select \"Generate QR Code\".")
                    }
                    Group {
